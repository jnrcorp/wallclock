...
public class ClockSettings {
    ...
    public ClockSettings(Context context) {
        ...
        String forecastFrequencyMinutes = preferences.getString(context.getString(R.string.pref_key_update_forecast_frequency), "30");
        this.updateForecastFrequencyMinutes = Integer.valueOf(forecastFrequencyMinutes);
        String currentFrequencyMinutes = preferences.getString(context.getString(R.string.pref_key_update_current_frequency), "30");
        this.updateCurrentFrequencyMinutes = Integer.valueOf(currentFrequencyMinutes);
